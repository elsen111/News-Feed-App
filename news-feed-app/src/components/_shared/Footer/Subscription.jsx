  ...
  return (
    <div className="flex justify-center sm:justify-end items-center order-2 xl:order-3 w-[90%] sm:w-[50%] xl:w-auto h-[30px]">
      <input
        type="email"
        name="search-box"
        className=" border border-[#ccc] w-[216px] h-full placeholder:text-(--text-muted) bg-(--input) rounded-l-md py-[5px] px-2.5 transition-all duration-300 text-[16px] text-(--text-primary) focus:shadow-[0_4px_15px_-5px_#000]"
